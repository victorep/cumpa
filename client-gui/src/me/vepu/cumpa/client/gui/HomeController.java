...
public class HomeController {
    ...
    private GroceryListArrayListImpl groceryListArrayListImpl = app.getGroceryListArrayListImpl();
                    ...
                    Platform.runLater(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (list.getSelectionModel().getSelectedIndex() > -1) {
                                groceryListArrayListImpl.remove(list.getSelectionModel().getSelectedIndex());
            ...
            public void run() {
                Platform.runLater(new Runnable() {
                    ...
                    public void run() {
                        reloadGroceries.setDisable(true);
                        try {
                            list.getItems().setAll(groceryListArrayListImpl);
